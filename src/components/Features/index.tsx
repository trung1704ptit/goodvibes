    ...
    <div className="py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center space-y-3 mb-12">
          <h2 className="text-4xl font-semibold text-gray-900 fade-in-up">999 Global Clients</h2>
          <h3 className="text-xl text-gray-700 fade-in-up">Trust GoodVibesITSolution</h3>
          <p className="text-lg text-gray-500 fade-in-up mt-0">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="text-center bg-white p-6 rounded-lg fade-in-up">
            <h4 className="text-xl font-medium text-gray-900 mb-2">World-Class Support</h4>
          ...
          {/* Feature 2 */}
          <div className="text-center bg-white p-6 rounded-lg fade-in-up">
            <h4 className="text-xl font-medium text-gray-900 mb-2">Documentation and Tutorials</h4>
            <p className="text-base text-gray-600">
          ...
          {/* Feature 3 */}
          <div className="text-center bg-white p-6 rounded-lg fade-in-up">
            <h4 className="text-xl font-medium text-gray-900 mb-2">Built In House</h4>
            <p className="text-base text-gray-600">
          ...
          {/* Feature 4 */}
          <div className="text-center bg-white p-6 rounded-lg fade-in-up">
            <h4 className="text-xl font-medium text-gray-900 mb-2">Free Lifetime Updates</h4>
            <p className="text-base text-gray-600">
